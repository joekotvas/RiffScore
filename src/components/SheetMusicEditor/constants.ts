...
// Ordered list of supported pitches - Treble clef (F3 to G6)
export const ORDERED_PITCHES = [
  'F3', 'G3', 'A3', 'B3',
...
// Ordered list of supported pitches - Bass clef (E1 to B4)
export const BASS_ORDERED_PITCHES = [
  'E1', 'F1', 'G1', 'A1', 'B1',
...
// Helper to get ordered pitches for a clef
export const getOrderedPitches = (clef: string = 'treble'): string[] => {
  return clef === 'bass' ? BASS_ORDERED_PITCHES : ORDERED_PITCHES;
};
