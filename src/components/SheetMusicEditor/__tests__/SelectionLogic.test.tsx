...
describe('Selection Utils', () => {
    ...
    describe('isNoteSelected', () => {
        ...
        it('returns true for primary cursor note', () => {
            expect(isNoteSelected(mockSelection, { staffIndex: 0, measureIndex: 0, eventId: 'e1', noteId: 'n1' })).toBe(true);
        });

        it('returns true for secondary selected note', () => {
            expect(isNoteSelected(mockSelection, { staffIndex: 0, measureIndex: 0, eventId: 'e1', noteId: 'n2' })).toBe(true);
        });
