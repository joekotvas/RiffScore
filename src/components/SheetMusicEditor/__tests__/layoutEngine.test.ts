...
describe('layoutEngine', () => {
    ...
    describe('calculateMeasureLayout with tuplets', () => {
        test('should process tuplet events with correct spacing', () => {
            const events: ScoreEvent[] = [
                { id: 'e1', duration: 'quarter', dotted: false, notes: [{ id: 'n1', pitch: 'C4' }], tuplet: { ratio: [3, 2], groupSize: 3, position: 0 } },
                { id: 'e2', duration: 'quarter', dotted: false, notes: [{ id: 'n2', pitch: 'D4' }], tuplet: { ratio: [3, 2], groupSize: 3, position: 1 } },
                { id: 'e3', duration: 'quarter', dotted: false, notes: [{ id: 'n3', pitch: 'E4' }], tuplet: { ratio: [3, 2], groupSize: 3, position: 2 } }
            ];
        ...
        test('should handle mixed-value tuplets with proportional spacing', () => {
            ...
            const events: ScoreEvent[] = [
                { id: 'e1', duration: 'eighth', dotted: false, notes: [{ id: 'n1', pitch: 'C4' }], tuplet: { ratio: [3, 2], groupSize: 3, position: 0 } },
                { id: 'e2', duration: 'quarter', dotted: false, notes: [{ id: 'n2', pitch: 'D4' }], tuplet: { ratio: [3, 2], groupSize: 3, position: 1 } },
                { id: 'e3', duration: 'eighth', dotted: false, notes: [{ id: 'n3', pitch: 'E4' }], tuplet: { ratio: [3, 2], groupSize: 3, position: 2 } }
            ];
