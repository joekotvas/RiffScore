...
const createComplexScore = (): Score => {
    ...
    const tupletNotes: ScoreEvent[] = [
        { id: 't1', duration: 'eighth', dotted: false, isRest: false, notes: [{ id: 'tn1', pitch: 'E4' }], tuplet: { ratio: [3, 2], groupSize: 3, position: 0 }, quant: 16 },
        { id: 't2', duration: 'eighth', dotted: false, isRest: false, notes: [{ id: 'tn2', pitch: 'F4' }], tuplet: { ratio: [3, 2], groupSize: 3, position: 1 }, quant: 21.33 },
        { id: 't3', duration: 'eighth', dotted: false, isRest: false, notes: [{ id: 'tn3', pitch: 'G4' }], tuplet: { ratio: [3, 2], groupSize: 3, position: 2 }, quant: 26.66 }
    ];
